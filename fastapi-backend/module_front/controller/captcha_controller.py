...
from common.entity.vo.login_vo import CaptchaCode
from common.service.captcha_service import CaptchaService
from utils.response_util import ResponseUtil
from utils.log_util import logger


captchaController = APIRouter(prefix='', tags=['前端验证码'])
