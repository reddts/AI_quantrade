...
from common.entity.vo.cache_vo import CacheInfoModel, CacheMonitorModel
from common.service.cache_service import CacheService
from common.service.login_service import LoginService
from utils.log_util import logger
from utils.response_util import ResponseUtil


cacheController = APIRouter(prefix='', dependencies=[Depends(LoginService.get_current_user)])
